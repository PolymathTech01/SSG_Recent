...
def express_time_in_minutes(seconds=0, minutes=0, hours=0, days=0):
    ...
    This function first check if the input provided are of required format, then it convert time in days, hours and seconds to minutes and add them together
...
def express_time_in_hours(seconds, minutes, hours, days):
    ...
    This function first check if the input provided are of required format, then it convert time in days, minutes and seconds to hours and add them together
...
def time_info(seconds=0, minutes=0, hours=0, days=0):
    ...
    This function first check if the input provided are of required format, and then store the time information in a dictionary

    returns -> dict
        A dictionary of the time information 
...
def addition_of_time(time_info_one, time_info_two):
    ...
    This function accepts two time data to be added together

    returns -> str
        Time expressed in days, hours, minutes and seconds
    """
...
def subtraction_of_time(time_info_one, time_info_two):
    ...
    This function accepts two time data to be subtracted from each other
